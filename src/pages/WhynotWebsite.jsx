  ...
  return (
    <div className='detail-page'>
      ...
      <div className='container'>
        ...
        <img src={`/wainao-redesign/wainao-redesign-1.jpg`} />
        {/* <div className='detail-padding' /> */}
        <div className='project__text'>
          <h3>Background</h3>
        ...
        <div className='project__grid'>
          ...
          <div><img src={`/wainao-redesign/wainao-redesign-before.jpg`} style={{ padding:"0% 5%" }} />
        ...
        <div className='project__grid' style={{ padding:"7% 0%"}}>
          ...
          <div>
            <img src={`/wainao-redesign/wainao-redesign-wip-1.jpg`} style={{ padding:"0% 5%" }}/>
          </div>
        </div>

        <img src={`/wainao-redesign/wainao-redesign-2.jpg`} />
        <img src={`/wainao-redesign/wainao-redesign-read.jpg`} />
        <img src={`/wainao-redesign/wainao-redesign-watch.jpg`} />
        <img src={`/wainao-redesign/wainao-redesign-3.jpg`} />
